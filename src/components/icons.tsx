...
/** Úprava – dosud inline SVG v hlavičce detailu */
...
/** Smazání – dosud inline SVG v hlavičce detailu */
export function TrashIcon(p: IconProps) {
  return <Svg {...p}><path d="M3 6h18" /><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" /></Svg>;
}
/** Uložení – dosud inline SVG v hlavičce detailu */
...
export function CopyIcon(p: IconProps) {
  return <Svg {...p}><rect x="9" y="9" width="12" height="12" rx="2" /><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" /></Svg>;
}
/** Zavřít / odebrat */
